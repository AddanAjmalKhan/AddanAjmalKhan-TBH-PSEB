...
import { LayoutDashboard, Users, Droplet, FileText, Settings, LogOut, ClipboardList } from "lucide-react"; // new icon ClipboardList
...
const menu = [
  ...
  { name: "Blood Requests", path: "/blood-requests", icon: ClipboardList }, // NEW
];
    ...
    <>
      <aside className="w-64 h-screen bg-[#070B14] border-r border-white/10 flex flex-col">
        <div className="flex items-center gap-3 px-6 h-16 border-b border-white/10">
          ...
          <span className="text-lg font-semibold text-white">Blood Heroes</span>
        </div>
            ...
            return (
              <NavLink
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition
                  ${isActive ? "bg-red-600 text-white shadow" : "text-gray-400 hover:bg-white/5 hover:text-white"}`}
              >
                <item.icon size={18} />
                {item.name}
              </NavLink>
        ...
        <div className="px-4 py-6 border-t border-white/10 space-y-2">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 px-4 py-2 rounded-lg text-sm transition text-red-400 hover:bg-red-500/10 hover:text-red-500"
          >
            <LogOut size={18} />
            Logout
          </button>
          ...
          <div className="bg-[#0F1524] rounded-xl p-6 w-[90%] max-w-sm shadow-xl border border-white/10">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-sm rounded-lg text-gray-300 hover:bg-white/10 transition"
              >
                Cancel
              </button>
              <button
